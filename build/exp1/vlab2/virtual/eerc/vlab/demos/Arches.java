	...
	//	cylinder.setCapability(TransformGroup.ALLOW_TRANSFORM_READ);
      ...
      objroot.addChild(objtrans);
	   ...
	   /* 
	    ...
	    obj3.addChild(m_j3d.createBox(new Vector3d(-0.30f,0.5f,-0.30f),new Vector3d(0.02f,0.02f,0.03f), new Vector3d(0.0f,0.0f,0.0f), m_j3d.getColor3f(256, 256, 256))); //bottom box1
